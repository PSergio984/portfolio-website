...
import { Code2, ShieldCheck, LayoutTemplate, Database, Cloud, Wrench } from 'lucide-react';
import {
  SiJavascript,
  SiTypescript,
  SiPython,
...
const skillCategories = [
  ...
  },
  {
    ...
    skills: [
      ...
      {
        name: 'shadcn/ui',
        icon: (props: ComponentProps<'img'>) => <img {...props} src={shadcnLogo} alt="shadcn/ui" />,
        color: '',
      },
...
export function Skills() {
  ...
  return (
    <section id="skills" aria-label="Skills & Technologies" className="py-8 overflow-hidden">
          ...
          {skillCategories.map(({ label, icon, skills }) => (
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <span className="p-2 rounded-lg bg-[var(--code-bg)]">{icon}</span>
