...
const awardsData: Credential[] = [
  ...
  },
  {
    ...
    date: 'April 2025',
    timestamp: '[APR 2025]',
    award: 'GOLD MEDAL â€” GENERAL IT & SYSTEMS LOGIC',
    iconType: 'gold',
  ...
  },
  {
    ...
    institution: 'Pamantasan ng Lungsod ng Valenzuela â€” BS Information Technology',
    date: '2023 - 2026',
    timestamp: '[2023 - 2026]',
    award: "CONSISTENT DEAN'S LISTER â€” 1.03 RUNNING GWA",
    iconType: 'gold',
...
const certificationsData: Credential[] = [
  ...
  },
  {
    ...
    title: 'Claude 101',
    institution: 'Anthropic â€” AI Fluency',
    date: '2026',
    timestamp: '[2026]',
    award: 'COMPLETION CERTIFICATE',
    iconType: 'security',
    imageUrl: '/assets/anthropic/anthropic-claude-101.webp',
  },
  {
  ...
  {
    id: 'anthropic-stud-fluency',
    title: 'Student Fluency',
    institution: 'Anthropic â€” AI Fluency',
    date: '2026',
    timestamp: '[2026]',
    award: 'COMPLETION CERTIFICATE',
    iconType: 'security',
    imageUrl: '/assets/anthropic/anthropic-stud-fluency.webp',
  },
  {
    id: 'anthropic-cowork',
    ...
    award: 'COMPLETION CERTIFICATE',
    iconType: 'security',
    imageUrl: '/assets/anthropic/anthropic-cowork.webp',
  },
  {
    id: 'anthropic-limitation',
    ...
    award: 'COMPLETION CERTIFICATE',
    iconType: 'security',
    imageUrl: '/assets/anthropic/anthropic-limitation.webp',
  },
  {
    id: 'datacamp-cert',
    title: 'DataCamp Certified',
    institution: 'DataCamp',
    date: '2026',
    timestamp: '[2026]',
    award: 'CERTIFICATE',
    iconType: 'design',
    imageUrl: '/assets/certificates/datacamp-certificate.webp',
  },
];
...
const programsData: Credential[] = [
  ...
  {
    id: 'gcp-arcade',
    title: 'Google Cloud Arcade Member',
    institution: 'Google Cloud Arcade Facilitator Program',
    date: 'July 2026 â€” Present',
    timestamp: '[JUL 2026 â€” PRESENT]',
    award: 'FACILITATOR',
    iconType: 'security',
...
function VerificationModal({
  ...
  const isPdf = selectedCred.imageUrl?.toLowerCase().endsWith('.webp');
