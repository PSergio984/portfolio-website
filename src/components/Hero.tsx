    ...
    >
      ...
      <div ref={ref} className={`${fadeClass}`}>
        ...
        <div className="text-lg sm:text-xl text-[var(--text)] mb-6 font-medium">
          ...
          focused on <span className="text-[var(--accent)] font-semibold">Cybersecurity</span> &
          Secure Systems
        </div>
        ...
        <p className="text-[var(--text-h)] text-lg sm:text-xl font-medium leading-relaxed mb-8 max-w-2xl opacity-90">
          I build secure, high-performance web applications and hunt vulnerabilities. By combining
          full-stack engineering with hands-on CTF competition experience, I design robust defense
          mechanisms and audit codebases from an attacker's perspective.
        </p>
            ...
            return (
              ...
              >
                <div>
                  ...
                  <h3 className="text-base font-bold text-[var(--text-h)] mb-2">{item.title}</h3>
